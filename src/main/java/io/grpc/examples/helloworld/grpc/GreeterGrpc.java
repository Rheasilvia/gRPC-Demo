...
public final class GreeterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          io.grpc.examples.helloworld.grpc.HelloRequest,
          io.grpc.examples.helloworld.grpc.HelloReply>
      getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = io.grpc.examples.helloworld.grpc.HelloRequest.class,
      responseType = io.grpc.examples.helloworld.grpc.HelloReply.class,
                  ...
                  io.grpc.MethodDescriptor
                      ...
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              io.grpc.examples.helloworld.grpc.HelloRequest.getDefaultInstance()))
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              io.grpc.examples.helloworld.grpc.HelloReply.getDefaultInstance()))
  ...
  public abstract static class GreeterImplBase implements io.grpc.BindableService {
    ...
    public void sayHello(
        io.grpc.examples.helloworld.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.grpc.HelloReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
              ...
              asyncUnaryCall(
                  new MethodHandlers<
                      io.grpc.examples.helloworld.grpc.HelloRequest,
                      io.grpc.examples.helloworld.grpc.HelloReply>(this, METHODID_SAY_HELLO)))
          .build();
    }
  }
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public io.grpc.examples.helloworld.grpc.HelloReply sayHello(
        io.grpc.examples.helloworld.grpc.HelloRequest request) {
  ...
  public static final class GreeterFutureStub extends io.grpc.stub.AbstractStub<GreeterFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            io.grpc.examples.helloworld.grpc.HelloReply>
        sayHello(io.grpc.examples.helloworld.grpc.HelloRequest request) {
      ...
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello(
              (io.grpc.examples.helloworld.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.grpc.HelloReply>)
                  responseObserver);
          break;
        default:
  ...
  private abstract static class GreeterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.grpc.examples.helloworld.grpc.HelloWorldProto.getDescriptor();
    }
